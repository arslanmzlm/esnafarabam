...
return [
    ...
    */
    ...
    'attributes' => [
        'active' => 'Aktiflik',
        'address' => 'Adres',
        'approved_photos' => 'Onaylanmış görseller',
        'approved_photos.*' => 'Onaylanmış görsel',
        'attributes' => 'Özellikler',
        'attributes.*.attribute_id' => 'Özellik',
        'attributes.*.id' => 'Özellik',
        'attributes.*.value' => 'Özellik değeri',
        'attribute_category_id' => 'Özellik kategorisi',
        'brand_id' => 'Marka',
        'code' => 'Kod',
        'company' => 'Firma',
        'company_phone' => 'Firma telefonu',
        'deleted_photos' => 'Silinmiş görseller',
        'deleted_photos.*' => 'Silinmiş görsel',
        ...
        'price' => 'Fiyat',
        'province_id' => 'İl',
        'rejected_photos' => 'Reddedilmiş görseller',
        'rejected_photos.*' => 'Reddedilmiş görsel',
        'required' => 'Zorunluluk',
        'series' => 'Seri',
        'slug' => 'SEO (URL)',
        'state' => 'Durum',
        'step_type' => 'Sihirbaz türü',
        'stock_code' => 'Stok kodu',
        'submodel' => 'Alt model',
        'surname' => 'Soyad',
        'tax_identity' => 'Vergi numarası',
        'title' => 'Başlık',
        'type' => 'Tip',
        'unit' => 'Birim',
        'username' => 'Kullanıcı adı',
        'values' => 'Özellikler',
        'values.*.attribute_id' => 'Özellik',
        'values.*.id' => 'Özellik',
        'values.*.value' => 'Özellik değeri',
        'vehicle_id' => 'Taşıt',
        'vehicle_type_id' => 'Taşıt türü',
        'year' => 'Yıl',
        'key' => 'Anahtar',
        'value' => 'Değer',
        'category' => 'Kategori',
        ...
        'field' => 'Alan',
        'alt_title' => 'Alternatif başlık',
        'sub_title' => 'Alt başlık',
        'excerpt' => 'Özet',
        'link_label' => 'Link başlığı',
        'link' => 'Link (URL)',
        'image' => 'Görsel',
